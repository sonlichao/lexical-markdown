...
const markdownCodeBlock = Object.assign(Object.assign({}, paragraphStartBase), { export: codeBlockExport, markdownFormatKind: "paragraphCodeBlock", regEx: /^(```)$/, regExForAutoFormatting: /^(```)([a-z]*)( )/ });
...
const markdownBold2 = Object.assign(Object.assign({}, autoFormatBase), { exportFormat: "bold", exportTag: "_", markdownFormatKind: "bold", regEx: /(__)(\s*)([^__]*)(\s*)(__)()/, regExForAutoFormatting: /(__)(\s*)([^__]*)(\s*)(__)(\s)$/ });
...
const markdownStrikethroughItalicBold = Object.assign(Object.assign({}, autoFormatBase), { markdownFormatKind: "strikethrough_italic_bold", regEx: /(~~_\*\*)(\s*\b)([^~~_**][^**_~~]*)(\b\s*)(\*\*_~~)()/, regExForAutoFormatting: /(~~_\*\*)(\s*\b)([^~~_**][^**_~~]*)(\b\s*)(\*\*_~~)(\s)$/ });
const markdownItalicbold = Object.assign(Object.assign({}, autoFormatBase), { markdownFormatKind: "italic_bold", regEx: /(_\*\*)(\s*\b)([^_**][^**_]*)(\b\s*)(\*\*_)/, regExForAutoFormatting: /(_\*\*)(\s*\b)([^_**][^**_]*)(\b\s*)(\*\*_)(\s)$/ });
const markdownStrikethroughItalic = Object.assign(Object.assign({}, autoFormatBase), { markdownFormatKind: "strikethrough_italic", regEx: /(~~_)(\s*)([^~~_][^_~~]*)(\s*)(_~~)/, regExForAutoFormatting: /(~~_)(\s*)([^~~_][^_~~]*)(\s*)(_~~)(\s)$/ });
